...
/**
 * 聊天会话页的 Tailwind class token,照搬自 chatPageStyles。
 * 调色与度量来自 中性灰设计:底 #fcfcfc、220px 侧栏带 #f4f4f4 右边框、
 * 墨色 #18181a、muted #858b9c / #757f9c、0.5px 发丝边 #e3e7f1、
 * 用户气泡 #f6f6f6、56px 头部、白底 composer 卡(#18181a 0.5px 边、14px 圆角、深色发送按钮)。
 */
...
// 执行记录(trace)token —— 保留以备后用;当前后端不发 trace 行,未启用
export const CHAT_TRACE_WRAP_CLASS = 'mb-[10px] min-w-0';
export const CHAT_TRACE_PANEL_CLASS =
  'w-full rounded-[14px] border border-[#e3e7f1] bg-white px-[16px] py-[12px] shadow-[0_1px_2px_rgba(24,24,26,0.03)]';
export const CHAT_TRACE_PANEL_HEADER_CLASS = 'flex items-center justify-between gap-[10px]';
export const CHAT_TRACE_PANEL_TITLE_CLASS = 'text-[12px] font-semibold tracking-normal text-[#464c5e]';
export const CHAT_TRACE_PANEL_META_CLASS = 'text-[11px] text-[#858b9c]';
export const CHAT_TRACE_STEPS_CLASS = 'mt-[10px] flex flex-wrap gap-[8px]';
export const CHAT_TRACE_STEP_CLASS =
  'inline-flex min-w-0 items-center gap-[7px] rounded-full border border-[#e3e7f1] bg-[#fafbfc] px-[10px] py-[6px] text-[12px] text-[#464c5e]';
export const CHAT_TRACE_STEP_RUNNING_CLASS = 'border-[#c9d2e4] bg-[#f5f7fb] text-[#18181a]';
export const CHAT_TRACE_STEP_DONE_CLASS = 'border-[#d9e6d9] bg-[#f6fbf6] text-[#166534]';
export const CHAT_TRACE_STEP_ERROR_CLASS = 'border-[#f0c1c1] bg-[#fff5f5] text-[#b42318]';
export const CHAT_TRACE_STEP_DOT_CLASS = 'size-[6px] shrink-0 rounded-full bg-current';
export const CHAT_TRACE_STEP_DOT_RUNNING_CLASS = 'animate-pulse';
export const CHAT_STREAM_TRACE_CLASS = 'mb-[12px] grid gap-[8px] border-l-[1.5px] border-[#eef0f4] pl-[12px]';
export const CHAT_STREAM_TRACE_ITEM_CLASS = 'grid gap-[3px]';
export const CHAT_STREAM_TRACE_HEAD_CLASS = 'flex items-center gap-[7px] text-[12px] font-medium leading-[1.5] text-[#464c5e]';
export const CHAT_STREAM_TRACE_STATUS_CLASS = 'shrink-0 rounded-full bg-[#eef0f4] px-[7px] py-[1px] text-[10px] font-semibold text-[#858b9c]';
export const CHAT_STREAM_TRACE_STATUS_RUNNING_CLASS = 'bg-[#edf2ff] text-[#1d4ed8]';
export const CHAT_STREAM_TRACE_STATUS_DONE_CLASS = 'bg-[#eef8f0] text-[#166534]';
export const CHAT_STREAM_TRACE_STATUS_ERROR_CLASS = 'bg-[#fce7e7] text-[#b42318]';
export const CHAT_STREAM_TRACE_DOT_CLASS = 'mt-[5px] size-[7px] shrink-0 rounded-full bg-[#18181a]';
export const CHAT_STREAM_TRACE_DOT_RUNNING_CLASS = 'animate-pulse';
export const CHAT_STREAM_TRACE_DETAIL_CLASS = 'whitespace-pre-wrap text-[12px] leading-[1.65] text-[#5b6273] wrap-anywhere';
...
export const CHAT_TRACE_FLOW_TEXT_CLASS = 'app-trace-flow-text';
